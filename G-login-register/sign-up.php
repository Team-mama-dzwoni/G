...
<div class="container">
    <div class="form">
        ...
        <form action="sing-up-process.php" method="post">
            ...
            <div class="birthdate_container">
                ...
                <div class="birthdate">
                    ...
                    <label for="day" class="form-group">
                        Day
                        <span class="wrapper">
        ...
        <p class="redirect">Already have an account? <a href="sign-in.php"> Sing in</a></p>
    </div>
</div>
